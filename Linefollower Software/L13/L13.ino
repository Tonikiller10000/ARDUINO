...
//cauta linie  
if (proportional>500 && -prop==limit+1 ) {bs=1;pf=pw;ps=pw/5;baga_linie();} //-prop==limit+1 conditie daca e pe alb
if (proportional<-500 && -prop==limit+1 ) {bd=1;pf=pw; ps=pw/5;baga_linie();}//
